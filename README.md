...
เพิ่ม ayeduplan1.thamdee.com ayeduplan2.thamdee.com และ ayedudata.thamdee.com ในหน้าหลัก คลังความรู้ และส่วนท้ายทุกหน้า พร้อมบทความ `content/related-planning.md` และการประยุกต์ในหน้ากลไกขับเคลื่อน ประเมินผล ความเชื่อมโยง โครงการ และหน่วยงาน

แก้การ์ดและลิงก์ย่อยได้ที่ `data/related-sites.json`; แก้รายการอ้างอิงที่ `data/sources.json`; ส่วนท้ายเป็นลิงก์คงที่ใน `js/site.js` การคัดเลือกใช้เน้นวิธีทำงานและบทเรียน พร้อมรักษาความต่างของกรอบแผนและขอบเขตตาราง ปี 2567 (110 คน) อยู่ในรายการรอตรวจ ไม่เติมลงกราฟหลักจนกว่าจะตรวจตารางต้นฉบับ
