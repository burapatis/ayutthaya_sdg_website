...
<a class="link-card" href="community.html"><span class="card-number">05 / อ่านง่าย</span><b>เปิดฉบับอ่านง่าย →</b><p>ภาษาชาวบ้าน ฉบับผู้เรียน และแผ่นพับพิมพ์แจก</p></a>
</div>
...
pages["community.html"] = wrap(
    "community",
    "ฉบับอ่านง่าย",
    "ฉบับภาษาชาวบ้าน ฉบับผู้เรียน และแผ่นพับพิมพ์แจก เรื่อง SDG 4 จังหวัดพระนครศรีอยุธยา — ไม่ใช่เว็บราชการและไม่ใช่มติอนุมัติ",
    "community.html",
    """<div class="breadcrumb">พระนครศรีอยุธยา / SDG 4 / ฉบับอ่านง่าย</div>
<header class="page-head">
<p class="eyebrow">EDUCATION FOR EVERYONE</p>
<h1>ฉบับอ่านง่าย: ชาวบ้านและผู้เรียน</h1>
<p>หน้าเหล่านี้เล่า SDG 4 เป็นภาษาคนทั่วไป สำหรับพ่อแม่ คนในหมู่บ้าน นักเรียน และผู้เรียน โดยไม่ต้องรอศัพท์ราชการ</p>
</header>
<p class="notice">ไม่ใช่เว็บราชการ และไม่ใช่เอกสารแจกของหน่วยงาน ตัวเลขที่ใช้เป็นชุดอ้างอิงเดียวกับหน้าแรก โครงงานและเรื่องสมมติใช้ให้เห็นภาพ ไม่ใช่รายงานโรงเรียนใดโรงเรียนหนึ่ง</p>
<div class="deck-pick">
...
<span class="eyebrow">03 · พิมพ์แจก</span>
...
<section class="panel" style="margin-top:24px">
<h2>วิธีใช้ให้เหมาะกับชาวบ้านและผู้เรียน</h2>
<ul>
