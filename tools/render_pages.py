...
<a class="role-card" href="ayutthaya-school-sdg4.html">
<span class="eyebrow">06 · สถานศึกษา</span>
<h2>ใบกรอกตัวชี้วัด SDG 4</h2>
<p>กรอกตัวตั้งตัวหารของโรงเรียน แล้วคำนวณค่าตามสูตรกรอบประเทศ — ไม่ใช่แบบฟอร์มราชการ</p>
</a>
</div>
...
pages["community.html"] = wrap(
    "community",
    "ฉบับอ่านง่าย",
    "ฉบับภาษาชาวบ้าน ฉบับผู้เรียน ชุดเครื่องมือครู ใบกรอกตัวชี้วัดสถานศึกษา และแผ่นพับพิมพ์แจก เรื่อง SDG 4 จังหวัดพระนครศรีอยุธยา — ไม่ใช่เว็บราชการและไม่ใช่มติอนุมัติ",
    "community.html",
    """<div class="breadcrumb">พระนครศรีอยุธยา / SDG 4 / ฉบับอ่านง่าย</div>
<header class="page-head">
<p class="eyebrow">EDUCATION FOR EVERYONE</p>
<h1>ฉบับอ่านง่าย: ตามบทบาท</h1>
<p>หน้าเหล่านี้เล่า SDG 4 เป็นภาษาที่ใช้ลงมือได้ สำหรับพ่อแม่ คนในหมู่บ้าน นักเรียน ผู้เรียน ครู ผู้บริหาร และสถานศึกษา โดยไม่ต้องรอศัพท์ราชการ</p>
</header>
...
<a class="deck-pick-card" href="ayutthaya-school-sdg4.html">
<span class="eyebrow">04 · สถานศึกษา</span>
<h2>ใบกรอกตัวชี้วัด SDG 4</h2>
<p>กรอกข้อมูลที่โรงเรียนให้ได้ ตามสูตรเอกสาร ศธจ. แล้วพิมพ์ใบสรุปส่งต้นสังกัด ค่าคำนวณอยู่บนเครื่องท่าน</p>
<p class="small muted">ไม่ใช่แบบฟอร์มราชการ ไม่ส่งข้อมูลขึ้นเซิร์ฟเวอร์ และตัวที่ต้องใช้ประชากรวัยจะไม่แต่งร้อยละ</p>
<span class="deck-pick-action">เปิดใบกรอกสถานศึกษา →</span>
</a>
<a class="deck-pick-card" href="ayutthaya-flyer.html">
<span class="eyebrow">05 · พิมพ์แจก</span>
...
<li>สถานศึกษาใช้ใบกรอกตัวชี้วัด SDG 4 เพื่อคำนวณค่าของตนเอง แล้วพิมพ์ใบสรุป ไม่ใช่การยื่นเรื่องผ่านเว็บนี้</li>
