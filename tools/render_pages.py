...
<a class="link-card" href="slides.html"><span class="card-number">04 / เล่าให้ผู้อื่นฟัง</span><b>เปิดสไลด์นำเสนอ →</b><p>ชุดสไลด์แนะนำเว็บไซต์ และ SDG 4 ในอยุธยา</p></a>
</div>
...
<p>เปิดนำเสนอเต็มจอได้ทันที ทั้งชุดเล่าวิธีใช้เว็บไซต์ และชุดเล่าสาระ SDG 4 ในจังหวัดพระนครศรีอยุธยา</p>
</header>
<p class="notice">ชุดสไลด์ใช้เล่าเรื่องตามหน้าเว็บนี้ ไม่ใช่เว็บราชการ ข้อเสนอโครงการและตัวชี้วัดยังไม่ใช่มติอนุมัติ ตัวเลขบนสไลด์เป็นชุดอ้างอิงเดียวกับหน้าแรก ไม่ปนกับข้อมูลจำลอง</p>
<div class="deck-pick">
